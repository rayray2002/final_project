...
void DoubleGameBoardComponent::update()
{
	...
	if (gameboard1.score % 2000 > 0 && gameboard1.score % 2000 < 500 && gameboard1.score > 0)
	{
		ch1skilled = true;
	}
	if (ch1skilled && ch1 != 2)
	...
	if (gameboard2.score % 2000 > 0 && gameboard2.score % 2000 < 500 && gameboard2.score > 0)
	{
		ch2skilled = true;
	}
	if (ch2skilled && ch2 != 2)
	...
	if (side == 2)
	{
		for (int i = 0; i < 13; i++)
			for (int j = 0; j < 6; j++)
			{
				...
				gameboard2.UnitArray[i][j].mapPosition += v;
		...
		for (int i = 0; i < 13; i++)
			for (int j = 0; j < 6; j++)
			{
				...
				if (gameboard1.UnitArray[i][j].isMoving)
				{
					...
					if (n == 1 && gameboard1.UnitArray[i][j].mapPosition != MovingPair1[0].mapPosition)
					{
						MovingPair1[n] = gameboard1.UnitArray[i][j];
					}
					++n;
		...
		for (int i = 0; i < 13; i++)
			for (int j = 0; j < 6; j++)
			{
				...
				if (gameboard2.UnitArray[i][j].isMoving)
				{
					...
					if (n == 1 && gameboard2.UnitArray[i][j].mapPosition != MovingPair2[0].mapPosition)
					{
						MovingPair2[n] = gameboard2.UnitArray[i][j];
					}
					++n;
...
void DoubleGameBoardComponent::TerisaSkill(int side)
{
	if (side == 1)
	{
...
void DoubleGameBoardComponent::RitaSkill(int side)
{
	if (side == 1)
	{
...
void DoubleGameBoardComponent::KianaSkill(int side)
{
	if (side == 1)
	{
		for (int j = 0; j < 6; j++)
