	...
	for (int i = 0; i < 13; i++)
	{
		for (int j = 0; j < 6; j++)
		{
			...
			case 1:
				if (rand() % 10 == 1)
				{
					texture = SDL_CreateTextureFromSurface(Renderer, surface_ba);
					break;
				}
				else
					texture = SDL_CreateTextureFromSurface(Renderer, surface_r);
				break;
			case 2:
				texture = SDL_CreateTextureFromSurface(Renderer, surface_g);
				break;
			case 4:
				texture = SDL_CreateTextureFromSurface(Renderer, surface_y);
				break;
			}
